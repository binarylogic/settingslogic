...
You can use these settings anywhere, for example in a model:  
  ...
  class Post < ActiveRecord::Base
    self.per_page = Settings.pagination.posts_per_page || 10
  end
...
Or, modifying our model example:

  class Post < ActiveRecord::Base
    self.per_page = Settings.pagination['posts_per_page'] || Settings.pagination.per_page
  end
